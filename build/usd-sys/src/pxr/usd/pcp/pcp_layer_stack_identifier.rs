...
pub fn pxrInternal_v0_21__pxrReserved___hash_value_5(return_: *mut usize, x: *const pxr_PcpLayerStackIdentifier_t) -> Exception;

pub fn pxrInternal_v0_21__pxrReserved___hash_value_6(return_: *mut usize, x: *const pxr_PcpLayerStackIdentifierStr_t) -> Exception;
