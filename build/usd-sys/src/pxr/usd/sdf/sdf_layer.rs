...
pub fn pxrInternal_v0_21__pxrReserved____SdfLayer_FindRelativeToLayer(return_: *mut *mut pxr_SdfLayerHandle_t, anchor: *const pxr_SdfLayerHandle_t, identifier: *const std_string_t, args: *const std_map_string_string_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfLayer_UpdateCompositionAssetDependency(this_: *mut pxr_SdfLayer_t, return_: *mut bool, old_asset_path: *const std_string_t, new_asset_path: *const std_string_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfLayer_UpdateAssetInfo(this_: *mut pxr_SdfLayer_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfLayer_GetResolvedPath(this_: *const pxr_SdfLayer_t, return_: *mut *const pxr_ArResolvedPath_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfLayer_ComputeAbsolutePath(this_: *const pxr_SdfLayer_t, return_: *mut *mut std_string_t, asset_path: *const std_string_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfLayer_GetFieldDictValueByKey(this_: *const pxr_SdfLayer_t, return_: *mut *mut pxr_VtValue_t, path: *const pxr_SdfPath_t, field_name: *const pxr_TfToken_t, key_path: *const pxr_TfToken_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfLayer_GetSubLayerOffset(this_: *const pxr_SdfLayer_t, return_: *mut *mut pxr_SdfLayerOffset_t, index: c_int) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfLayer_GetBracketingTimeSamples(this_: *mut pxr_SdfLayer_t, return_: *mut bool, time: c_double, t_lower: *mut c_double, t_upper: *mut c_double) -> Exception;

pub fn pxrInternal_v0_21__pxrReserved____SdfLayer_GetNumTimeSamplesForPath(this_: *const pxr_SdfLayer_t, return_: *mut usize, path: *const pxr_SdfPath_t) -> Exception;

pub fn pxrInternal_v0_21__pxrReserved____SdfLayer_GetBracketingTimeSamplesForPath(this_: *mut pxr_SdfLayer_t, return_: *mut bool, path: *const pxr_SdfPath_t, time: c_double, t_lower: *mut c_double, t_upper: *mut c_double) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfLayer_DumpLayerInfo() -> Exception;

pub fn pxrInternal_v0_21__pxrReserved____SdfLayer_WriteDataFile(this_: *mut pxr_SdfLayer_t, return_: *mut bool, filename: *const std_string_t) -> Exception;
