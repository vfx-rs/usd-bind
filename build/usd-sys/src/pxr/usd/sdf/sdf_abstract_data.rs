...
#[repr(C)]
pub struct pxrInternal_v0_21__pxrReserved____SdfAbstractDataConstValue_t {
    _unused: [u8; 0],
}
#[repr(C)]
pub struct pxrInternal_v0_21__pxrReserved____SdfAbstractDataValue_t {
    _unused: [u8; 0],
}
...
pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractData_Has(this_: *const pxr_SdfAbstractData_t, return_: *mut bool, path: *const pxr_SdfPath_t, field_name: *const pxr_TfToken_t, value: *mut pxr_SdfAbstractDataValue_t) -> Exception;

pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractData_Has_1(this_: *const pxr_SdfAbstractData_t, return_: *mut bool, path: *const pxr_SdfPath_t, field_name: *const pxr_TfToken_t, value: *mut pxr_VtValue_t) -> Exception;

pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractData_Get(this_: *const pxr_SdfAbstractData_t, return_: *mut *mut pxr_VtValue_t, path: *const pxr_SdfPath_t, field_name: *const pxr_TfToken_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractData_Set_1(this_: *mut pxr_SdfAbstractData_t, path: *const pxr_SdfPath_t, field_name: *const pxr_TfToken_t, value: *const pxr_SdfAbstractDataConstValue_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractData_HasDictKey(this_: *const pxr_SdfAbstractData_t, return_: *mut bool, path: *const pxr_SdfPath_t, field_name: *const pxr_TfToken_t, key_path: *const pxr_TfToken_t, value: *mut pxr_SdfAbstractDataValue_t) -> Exception;

pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractData_HasDictKey_1(this_: *const pxr_SdfAbstractData_t, return_: *mut bool, path: *const pxr_SdfPath_t, field_name: *const pxr_TfToken_t, key_path: *const pxr_TfToken_t, value: *mut pxr_VtValue_t) -> Exception;

pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractData_GetDictValueByKey(this_: *const pxr_SdfAbstractData_t, return_: *mut *mut pxr_VtValue_t, path: *const pxr_SdfPath_t, field_name: *const pxr_TfToken_t, key_path: *const pxr_TfToken_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractData_SetDictValueByKey_1(this_: *mut pxr_SdfAbstractData_t, path: *const pxr_SdfPath_t, field_name: *const pxr_TfToken_t, key_path: *const pxr_TfToken_t, value: *const pxr_SdfAbstractDataConstValue_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractData_QueryTimeSample_1(this_: *const pxr_SdfAbstractData_t, return_: *mut bool, path: *const pxr_SdfPath_t, time: c_double, optional_value: *mut pxr_SdfAbstractDataValue_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractDataConstValue_GetValue(this_: *const pxr_SdfAbstractDataConstValue_t, return_: *mut bool, value: *mut pxr_VtValue_t) -> Exception;

pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractDataConstValue_IsEqual(this_: *const pxr_SdfAbstractDataConstValue_t, return_: *mut bool, value: *const pxr_VtValue_t) -> Exception;

pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractDataConstValue_dtor(this_: *mut pxr_SdfAbstractDataConstValue_t) -> Exception;

pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractDataValue_StoreValue(this_: *mut pxr_SdfAbstractDataValue_t, return_: *mut bool, value: *const pxr_VtValue_t) -> Exception;

pub fn pxrInternal_v0_21__pxrReserved____SdfAbstractDataValue_dtor(this_: *mut pxr_SdfAbstractDataValue_t) -> Exception;
