...
pub fn pxrInternal_v0_21__pxrReserved____SdfPath_GetAsToken(this_: *const pxr_SdfPath_t, return_: *mut pxr_TfToken_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfPath_GetAsString(this_: *const pxr_SdfPath_t, return_: *mut *mut std_string_t) -> Exception;
...
pub fn pxrInternal_v0_21__pxrReserved____SdfPath_GetAncestorsRange(this_: *const pxr_SdfPath_t, return_: *mut *mut pxr_SdfPathAncestorsRange_t) -> Exception;
