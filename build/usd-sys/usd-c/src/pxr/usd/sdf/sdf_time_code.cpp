...
{
        return sizeof(pxrInternal_v0_21__pxrReserved__::SdfTimeCode);
}

USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____SdfTimeCode_alignof()
{
        return alignof(pxrInternal_v0_21__pxrReserved__::SdfTimeCode);
}
...
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____SdfTimeCode_ctor(
    ...
    , double time)
{
        new (this_) pxrInternal_v0_21__pxrReserved__::SdfTimeCode(time);
        return 0;
}
...
{
    try {
        new (this_) pxrInternal_v0_21__pxrReserved__::SdfTimeCode(to_cpp_ref(rhs));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____SdfTimeCode_dtor(
    pxr_SdfTimeCode_t * this_)
{
        (to_cpp(this_)) -> pxrInternal_v0_21__pxrReserved__::SdfTimeCode::~SdfTimeCode();
        return 0;
}
