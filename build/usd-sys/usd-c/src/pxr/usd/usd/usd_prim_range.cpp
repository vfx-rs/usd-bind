...
{
    try {
        to_c(this_, new pxrInternal_v0_21__pxrReserved__::UsdPrimRange());
        return 0;
...
{
    try {
        to_c(this_, new pxrInternal_v0_21__pxrReserved__::UsdPrimRange(to_cpp_ref(start)));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        to_c(this_, new pxrInternal_v0_21__pxrReserved__::UsdPrimRange(to_cpp_ref(start), to_cpp_ref(predicate)));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        to_c_copy(return_, pxrInternal_v0_21__pxrReserved__::UsdPrimRange::PreAndPostVisit(to_cpp_ref(start)));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        to_c_copy(return_, pxrInternal_v0_21__pxrReserved__::UsdPrimRange::PreAndPostVisit(to_cpp_ref(start), to_cpp_ref(predicate)));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        to_c_copy(return_, pxrInternal_v0_21__pxrReserved__::UsdPrimRange::AllPrims(to_cpp_ref(start)));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        to_c_copy(return_, pxrInternal_v0_21__pxrReserved__::UsdPrimRange::AllPrimsPreAndPostVisit(to_cpp_ref(start)));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        to_c(this_, new pxrInternal_v0_21__pxrReserved__::UsdPrimRange(to_cpp_ref(rhs)));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
        return sizeof(pxrInternal_v0_21__pxrReserved__::UsdPrimRange::iterator);
}

USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____UsdPrimRange__iterator_alignof()
{
        return alignof(pxrInternal_v0_21__pxrReserved__::UsdPrimRange::iterator);
}
...
{
    try {
        new (this_) pxrInternal_v0_21__pxrReserved__::UsdPrimRange::iterator();
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        new (this_) pxrInternal_v0_21__pxrReserved__::UsdPrimRange::iterator(to_cpp_ref(&(e)));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        new (this_) pxrInternal_v0_21__pxrReserved__::UsdPrimRange::iterator(to_cpp_ref(rhs));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____UsdPrimRange__iterator_dtor(
    pxr_UsdPrimRange_iterator_t * this_)
{
        (to_cpp(this_)) -> pxrInternal_v0_21__pxrReserved__::UsdPrimRange::iterator::~iterator();
        return 0;
}

USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____UsdPrimRange__EndSentinel_sizeof()
{
        return sizeof(pxrInternal_v0_21__pxrReserved__::UsdPrimRange::EndSentinel);
}

USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____UsdPrimRange__EndSentinel_alignof()
{
        return alignof(pxrInternal_v0_21__pxrReserved__::UsdPrimRange::EndSentinel);
}
...
{
    try {
        new (this_) pxrInternal_v0_21__pxrReserved__::UsdPrimRange::EndSentinel(to_cpp_ref(rhs));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____UsdPrimRange__EndSentinel_dtor(
    pxr_UsdPrimRange_EndSentinel_t * this_)
{
        (to_cpp(this_)) -> pxrInternal_v0_21__pxrReserved__::UsdPrimRange::EndSentinel::~EndSentinel();
        return 0;
}
