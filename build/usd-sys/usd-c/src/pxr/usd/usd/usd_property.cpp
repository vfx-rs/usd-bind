...
{
    try {
        *(return_) = pxrInternal_v0_21__pxrReserved__::UsdProperty::GetNamespaceDelimiter();
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        to_c(this_, new pxrInternal_v0_21__pxrReserved__::UsdProperty());
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        to_c(this_, new pxrInternal_v0_21__pxrReserved__::UsdProperty(to_cpp_ref(rhs)));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
