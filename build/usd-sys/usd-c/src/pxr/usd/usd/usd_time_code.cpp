...
{
        return sizeof(pxrInternal_v0_21__pxrReserved__::UsdTimeCode);
}

USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____UsdTimeCode_alignof()
{
        return alignof(pxrInternal_v0_21__pxrReserved__::UsdTimeCode);
}
...
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____UsdTimeCode_ctor(
    ...
    , double t)
{
        new (this_) pxrInternal_v0_21__pxrReserved__::UsdTimeCode(t);
        return 0;
}
...
{
        new (this_) pxrInternal_v0_21__pxrReserved__::UsdTimeCode(to_cpp_ref(timeCode));
        return 0;
}
...
{
    try {
        to_c_copy(return_, pxrInternal_v0_21__pxrReserved__::UsdTimeCode::EarliestTime());
        return 0;
...
{
    try {
        to_c_copy(return_, pxrInternal_v0_21__pxrReserved__::UsdTimeCode::Default());
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        *(return_) = pxrInternal_v0_21__pxrReserved__::UsdTimeCode::SafeStep(maxValue, maxCompression);
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        new (this_) pxrInternal_v0_21__pxrReserved__::UsdTimeCode(to_cpp_ref(rhs));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____UsdTimeCode_dtor(
    pxr_UsdTimeCode_t * this_)
{
        (to_cpp(this_)) -> pxrInternal_v0_21__pxrReserved__::UsdTimeCode::~UsdTimeCode();
        return 0;
}
