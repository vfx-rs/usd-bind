...
{
    try {
        to_c(this_, new pxrInternal_v0_21__pxrReserved__::TfWeakPtr<pxr::SdfLayer>());
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        to_c(this_, new pxrInternal_v0_21__pxrReserved__::TfWeakPtr<pxr::SdfLayer>(to_cpp_ref(p)));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        to_c(this_, new pxrInternal_v0_21__pxrReserved__::TfWeakPtr<pxr::UsdStage>());
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
    try {
        to_c(this_, new pxrInternal_v0_21__pxrReserved__::TfWeakPtr<pxr::UsdStage>(to_cpp_ref(p)));
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
