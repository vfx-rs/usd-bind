...
{
    try {
        to_c(this_, new pxrInternal_v0_21__pxrReserved__::TfType());
        return 0;
...
{
    try {
        to_c(return_, pxrInternal_v0_21__pxrReserved__::TfType::GetUnknownType());
        return 0;
    } catch (std::exception& e) {
        TLG_EXCEPTION_STRING = e.what();
        return -1;
...
{
        to_c(this_, new pxrInternal_v0_21__pxrReserved__::TfType(to_cpp_ref(rhs)));
        return 0;
}
