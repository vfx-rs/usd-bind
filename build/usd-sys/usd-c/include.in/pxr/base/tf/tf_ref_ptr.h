...
typedef struct pxrInternal_v0_21__pxrReserved____TfRefPtr_pxr__UsdStage__t_s {
    char _unused;
} USD_CPPMM_ALIGN(8) pxrInternal_v0_21__pxrReserved____TfRefPtr_pxr__UsdStage__t;
...
#define pxr_UsdStageRefPtr_copy pxrInternal_v0_21__pxrReserved____TfRefPtr_pxr__UsdStage__copy
...
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____TfRefPtr_pxr__UsdStage__dtor(
    pxr_UsdStageRefPtr_t * this_);
#define pxr_UsdStageRefPtr_dtor pxrInternal_v0_21__pxrReserved____TfRefPtr_pxr__UsdStage__dtor
...
#define pxr_UsdStageRefPtr_deref pxrInternal_v0_21__pxrReserved____TfRefPtr_pxr__UsdStage__deref
...
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____TfRefPtr_pxr__UsdStage__is_null(
    pxr_UsdStageRefPtr_t const * this_
    , _Bool * return_);
#define pxr_UsdStageRefPtr_is_null pxrInternal_v0_21__pxrReserved____TfRefPtr_pxr__UsdStage__is_null
