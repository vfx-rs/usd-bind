...
typedef struct pxrInternal_v0_21__pxrReserved____TfError_t_s {
    char _unused;
} USD_CPPMM_ALIGN(8) pxrInternal_v0_21__pxrReserved____TfError_t;
typedef pxrInternal_v0_21__pxrReserved____TfError_t pxr_TfError_t;
...
#define pxr_TfError_GetErrorCodeAsString pxrInternal_v0_21__pxrReserved____TfError_GetErrorCodeAsString
