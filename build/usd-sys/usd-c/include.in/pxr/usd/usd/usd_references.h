...
typedef struct pxrInternal_v0_21__pxrReserved____UsdReferences_t_s {
    char _unused;
} USD_CPPMM_ALIGN(8) pxrInternal_v0_21__pxrReserved____UsdReferences_t;
...
#define pxr_UsdReferences_AddReference pxrInternal_v0_21__pxrReserved____UsdReferences_AddReference
...
#define pxr_UsdReferences_RemoveReference pxrInternal_v0_21__pxrReserved____UsdReferences_RemoveReference
...
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____UsdReferences_ClearReferences(
    pxr_UsdReferences_t * this_
    , _Bool * return_);
#define pxr_UsdReferences_ClearReferences pxrInternal_v0_21__pxrReserved____UsdReferences_ClearReferences


USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____UsdReferences_copy(
    pxr_UsdReferences_t * * this_
    , pxr_UsdReferences_t const * rhs);
#define pxr_UsdReferences_copy pxrInternal_v0_21__pxrReserved____UsdReferences_copy
