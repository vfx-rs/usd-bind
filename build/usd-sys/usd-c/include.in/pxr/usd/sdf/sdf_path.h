...
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____SdfPath_GetAsToken(
    pxr_SdfPath_t const * this_
    , pxr_TfToken_t * return_);
#define pxr_SdfPath_GetAsToken pxrInternal_v0_21__pxrReserved____SdfPath_GetAsToken
...
output.  Use the SdfPath API to manipulate paths.  It is less
error-prone and has better performance. */
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____SdfPath_GetAsString(
    pxr_SdfPath_t const * this_
    , std_string_t * * return_);
#define pxr_SdfPath_GetAsString pxrInternal_v0_21__pxrReserved____SdfPath_GetAsString
...
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____SdfPath_GetAncestorsRange(
    pxr_SdfPath_t const * this_
    , pxr_SdfPathAncestorsRange_t * * return_);
#define pxr_SdfPath_GetAncestorsRange pxrInternal_v0_21__pxrReserved____SdfPath_GetAncestorsRange
