...
represents. */
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____SdfVariantSpec_GetSpecType(
    pxr_SdfVariantSpec_t const * this_
    , pxr_SdfSpecType * return_);
#define pxr_SdfVariantSpec_GetSpecType pxrInternal_v0_21__pxrReserved____SdfVariantSpec_GetSpecType
