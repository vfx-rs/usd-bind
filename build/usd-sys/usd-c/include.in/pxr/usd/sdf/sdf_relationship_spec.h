...
@{ */
USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____SdfRelationshipSpec__eq(
    pxr_SdfRelationshipSpec_t const * this_
    , _Bool * return_
    , pxr_SdfSpec_t const * rhs);
#define pxr_SdfRelationshipSpec__eq pxrInternal_v0_21__pxrReserved____SdfRelationshipSpec__eq


USD_CPPMM_API unsigned int pxrInternal_v0_21__pxrReserved____SdfRelationshipSpec_operator_(
    pxr_SdfRelationshipSpec_t const * this_
    , _Bool * return_
    , pxr_SdfSpec_t const * rhs);
#define pxr_SdfRelationshipSpec_operator_ pxrInternal_v0_21__pxrReserved____SdfRelationshipSpec_operator_
