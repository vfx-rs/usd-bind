...
typedef struct pxrInternal_v0_20__pxrReserved____UsdGeomXform_t_s {
    char _unused;
} USD_CPPMM_ALIGN(8) pxrInternal_v0_20__pxrReserved____UsdGeomXform_t;
typedef pxrInternal_v0_20__pxrReserved____UsdGeomXform_t pxr_UsdGeomXform_t;
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdGeomXform_IsConcrete(
    ...
    , _Bool * return_);
#define pxr_UsdGeomXform_IsConcrete pxrInternal_v0_20__pxrReserved____UsdGeomXform_IsConcrete
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdGeomXform_IsTyped(
    pxr_UsdGeomXform_t const * this_
    , _Bool * return_);
#define pxr_UsdGeomXform_IsTyped pxrInternal_v0_20__pxrReserved____UsdGeomXform_IsTyped
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdGeomXform_IsAPISchema(
    pxr_UsdGeomXform_t const * this_
    , _Bool * return_);
#define pxr_UsdGeomXform_IsAPISchema pxrInternal_v0_20__pxrReserved____UsdGeomXform_IsAPISchema
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdGeomXform_IsAppliedAPISchema(
    pxr_UsdGeomXform_t const * this_
    , _Bool * return_);
#define pxr_UsdGeomXform_IsAppliedAPISchema pxrInternal_v0_20__pxrReserved____UsdGeomXform_IsAppliedAPISchema
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdGeomXform_IsMultipleApplyAPISchema(
    pxr_UsdGeomXform_t const * this_
    , _Bool * return_);
#define pxr_UsdGeomXform_IsMultipleApplyAPISchema pxrInternal_v0_20__pxrReserved____UsdGeomXform_IsMultipleApplyAPISchema
...
#define pxr_UsdGeomXform_GetPrim pxrInternal_v0_20__pxrReserved____UsdGeomXform_GetPrim
...
#define pxr_UsdGeomXform_GetPath pxrInternal_v0_20__pxrReserved____UsdGeomXform_GetPath
...
#define pxr_UsdGeomXform_Define pxrInternal_v0_20__pxrReserved____UsdGeomXform_Define
...
#define pxr_UsdGeomXform_copy pxrInternal_v0_20__pxrReserved____UsdGeomXform_copy
