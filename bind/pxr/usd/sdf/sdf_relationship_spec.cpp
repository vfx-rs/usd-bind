...
struct SdfRelationshipSpec {
    using BoundType = pxr::SdfRelationshipSpec;
    ...
    SdfRelationshipSpec(const pxr::SdfRelationshipSpec& spec);

    SdfRelationshipSpec(const pxr::Sdf_IdentityRefPtr& identity);
    ...
    static pxr::SdfRelationshipSpecHandle New(const pxr::SdfPrimSpecHandle& owner, const std::string& name, bool custom, pxr::SdfVariability variability);
    ...
    void ReplaceTargetPath(const pxr::SdfPath& oldPath, const pxr::SdfPath& newPath);
