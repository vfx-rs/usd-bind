...
struct SdfPrimSpec {
    using BoundType = pxr::SdfPrimSpec;
    ...
    SdfPrimSpec(const pxr::SdfPrimSpec& spec);

    SdfPrimSpec(const pxr::Sdf_IdentityRefPtr& identity);
    ...
    pxr::SdfPrimSpec& operator=(const pxr::SdfPrimSpec& );
...
pxr::SdfPrimSpecHandle SdfCreatePrimInLayer(const pxr::SdfLayerHandle& layer, const pxr::SdfPath& primPath);
...
bool SdfJustCreatePrimInLayer(const pxr::SdfLayerHandle& layer, const pxr::SdfPath& primPath);
