...
typedef struct pxrInternal_v0_20__pxrReserved____UsdAttribute_t_s pxrInternal_v0_20__pxrReserved____UsdAttribute_t;
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdPrim_IsHidden(
    pxr_UsdPrim_t const * this_
    , _Bool * return_);
#define pxr_UsdPrim_IsHidden pxrInternal_v0_20__pxrReserved____UsdPrim_IsHidden
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdPrim_SetHidden(
    ...
    , _Bool * return_
    , _Bool hidden);
#define pxr_UsdPrim_SetHidden pxrInternal_v0_20__pxrReserved____UsdPrim_SetHidden
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdPrim_ClearHidden(
    pxr_UsdPrim_t const * this_
    , _Bool * return_);
#define pxr_UsdPrim_ClearHidden pxrInternal_v0_20__pxrReserved____UsdPrim_ClearHidden
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdPrim_HasAuthoredHidden(
    pxr_UsdPrim_t const * this_
    , _Bool * return_);
#define pxr_UsdPrim_HasAuthoredHidden pxrInternal_v0_20__pxrReserved____UsdPrim_HasAuthoredHidden
...
#define pxr_UsdPrim_GetAttributeAtPath pxrInternal_v0_20__pxrReserved____UsdPrim_GetAttributeAtPath
...
#define pxr_UsdPrim_GetAttributes pxrInternal_v0_20__pxrReserved____UsdPrim_GetAttributes
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdPrim_GetAuthoredAttributes(
    pxr_UsdPrim_t const * this_
    , std_UsdAttributeVector_t * * return_);
#define pxr_UsdPrim_GetAuthoredAttributes pxrInternal_v0_20__pxrReserved____UsdPrim_GetAuthoredAttributes
...
#define pxr_UsdPrim_GetAttribute pxrInternal_v0_20__pxrReserved____UsdPrim_GetAttribute
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdPrim_HasAttribute(
    ...
    , _Bool * return_
    , pxr_TfToken_t const * attrName);
#define pxr_UsdPrim_HasAttribute pxrInternal_v0_20__pxrReserved____UsdPrim_HasAttribute
