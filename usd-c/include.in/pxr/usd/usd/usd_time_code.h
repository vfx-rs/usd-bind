...
typedef struct pxrInternal_v0_20__pxrReserved____UsdTimeCode_t_s {
    char data[%SIZEpxrInternal_v0_20__pxrReserved__::UsdTimeCode%];
} USD_CPPMM_ALIGN(%ALIGNpxrInternal_v0_20__pxrReserved__::UsdTimeCode%) pxrInternal_v0_20__pxrReserved____UsdTimeCode_t;
...
#define pxr_UsdTimeCode_sizeof pxrInternal_v0_20__pxrReserved____UsdTimeCode_sizeof


/** returns the size of this type in bytes */
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdTimeCode_alignof();
#define pxr_UsdTimeCode_alignof pxrInternal_v0_20__pxrReserved____UsdTimeCode_alignof
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdTimeCode_ctor(
    ...
    , double t);
#define pxr_UsdTimeCode_ctor pxrInternal_v0_20__pxrReserved____UsdTimeCode_ctor
...
#define pxr_UsdTimeCode_from_SdfTimeCode pxrInternal_v0_20__pxrReserved____UsdTimeCode_from_SdfTimeCode
...
#define pxr_UsdTimeCode_EarliestTime pxrInternal_v0_20__pxrReserved____UsdTimeCode_EarliestTime
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdTimeCode_Default(
    pxr_UsdTimeCode_t * return_);
#define pxr_UsdTimeCode_Default pxrInternal_v0_20__pxrReserved____UsdTimeCode_Default
...
#define pxr_UsdTimeCode_SafeStep pxrInternal_v0_20__pxrReserved____UsdTimeCode_SafeStep
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdTimeCode_IsEarliestTime(
    ...
    , _Bool * return_);
#define pxr_UsdTimeCode_IsEarliestTime pxrInternal_v0_20__pxrReserved____UsdTimeCode_IsEarliestTime
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdTimeCode_IsDefault(
    pxr_UsdTimeCode_t const * this_
    , _Bool * return_);
#define pxr_UsdTimeCode_IsDefault pxrInternal_v0_20__pxrReserved____UsdTimeCode_IsDefault
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdTimeCode_IsNumeric(
    pxr_UsdTimeCode_t const * this_
    , _Bool * return_);
#define pxr_UsdTimeCode_IsNumeric pxrInternal_v0_20__pxrReserved____UsdTimeCode_IsNumeric
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdTimeCode_GetValue(
    pxr_UsdTimeCode_t const * this_
    , double * return_);
#define pxr_UsdTimeCode_GetValue pxrInternal_v0_20__pxrReserved____UsdTimeCode_GetValue


USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdTimeCode_copy(
    pxr_UsdTimeCode_t * this_
    , pxr_UsdTimeCode_t const * rhs);
#define pxr_UsdTimeCode_copy pxrInternal_v0_20__pxrReserved____UsdTimeCode_copy


USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdTimeCode_dtor(
    pxr_UsdTimeCode_t * this_);
#define pxr_UsdTimeCode_dtor pxrInternal_v0_20__pxrReserved____UsdTimeCode_dtor
