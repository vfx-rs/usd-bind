...
typedef struct pxrInternal_v0_20__pxrReserved____UsdGeomLinearUnits_t_s {
    char _unused;
} USD_CPPMM_ALIGN(1) pxrInternal_v0_20__pxrReserved____UsdGeomLinearUnits_t;
typedef pxrInternal_v0_20__pxrReserved____UsdGeomLinearUnits_t pxr_UsdGeomLinearUnits_t;
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved___UsdGeomGetStageUpAxis(
    pxr_TfToken_t * return_
    , pxr_UsdStagePtr_t const * stage);
#define pxr_UsdGeomGetStageUpAxis pxrInternal_v0_20__pxrReserved___UsdGeomGetStageUpAxis
...
\sa UsdGeomUpAxis_group */
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved___UsdGeomSetStageUpAxis(
    _Bool * return_
    , pxr_UsdStagePtr_t const * stage
    , pxr_TfToken_t const * axis);
#define pxr_UsdGeomSetStageUpAxis pxrInternal_v0_20__pxrReserved___UsdGeomSetStageUpAxis
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved___UsdGeomGetFallbackUpAxis(
    pxr_TfToken_t * return_);
#define pxr_UsdGeomGetFallbackUpAxis pxrInternal_v0_20__pxrReserved___UsdGeomGetFallbackUpAxis


/** Return *stage*'s authored *metersPerUnit*, or 0.01 if unauthored.
\sa UsdGeomLinearUnits_group */
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved___UsdGeomGetStageMetersPerUnit(
    double * return_
    , pxr_UsdStagePtr_t const * stage);
#define pxr_UsdGeomGetStageMetersPerUnit pxrInternal_v0_20__pxrReserved___UsdGeomGetStageMetersPerUnit


/** Return whether *stage* has an authored *metersPerUnit*.
\sa UsdGeomLinearUnits_group */
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved___UsdGeomStageHasAuthoredMetersPerUnit(
    _Bool * return_
    , pxr_UsdStagePtr_t const * stage);
#define pxr_UsdGeomStageHasAuthoredMetersPerUnit pxrInternal_v0_20__pxrReserved___UsdGeomStageHasAuthoredMetersPerUnit
...
\sa UsdGeomLinearUnits_group */
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved___UsdGeomSetStageMetersPerUnit(
    _Bool * return_
    , pxr_UsdStagePtr_t const * stage
    , double metersPerUnit);
#define pxr_UsdGeomSetStageMetersPerUnit pxrInternal_v0_20__pxrReserved___UsdGeomSetStageMetersPerUnit
...
\sa UsdGeomLinearUnits_group */
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved___UsdGeomLinearUnitsAre(
    _Bool * return_
    , double authoredUnits
    , double standardUnits
    , double epsilon);
#define pxr_UsdGeomLinearUnitsAre pxrInternal_v0_20__pxrReserved___UsdGeomLinearUnitsAre
