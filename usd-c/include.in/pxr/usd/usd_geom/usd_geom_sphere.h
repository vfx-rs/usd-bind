...
typedef struct pxrInternal_v0_20__pxrReserved____UsdGeomSphere_t_s {
    char _unused;
} USD_CPPMM_ALIGN(8) pxrInternal_v0_20__pxrReserved____UsdGeomSphere_t;
typedef pxrInternal_v0_20__pxrReserved____UsdGeomSphere_t pxr_UsdGeomSphere_t;
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdGeomSphere_IsConcrete(
    ...
    , _Bool * return_);
#define pxr_UsdGeomSphere_IsConcrete pxrInternal_v0_20__pxrReserved____UsdGeomSphere_IsConcrete
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdGeomSphere_IsTyped(
    pxr_UsdGeomSphere_t const * this_
    , _Bool * return_);
#define pxr_UsdGeomSphere_IsTyped pxrInternal_v0_20__pxrReserved____UsdGeomSphere_IsTyped
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdGeomSphere_IsAPISchema(
    pxr_UsdGeomSphere_t const * this_
    , _Bool * return_);
#define pxr_UsdGeomSphere_IsAPISchema pxrInternal_v0_20__pxrReserved____UsdGeomSphere_IsAPISchema
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdGeomSphere_IsAppliedAPISchema(
    pxr_UsdGeomSphere_t const * this_
    , _Bool * return_);
#define pxr_UsdGeomSphere_IsAppliedAPISchema pxrInternal_v0_20__pxrReserved____UsdGeomSphere_IsAppliedAPISchema
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____UsdGeomSphere_IsMultipleApplyAPISchema(
    pxr_UsdGeomSphere_t const * this_
    , _Bool * return_);
#define pxr_UsdGeomSphere_IsMultipleApplyAPISchema pxrInternal_v0_20__pxrReserved____UsdGeomSphere_IsMultipleApplyAPISchema
...
#define pxr_UsdGeomSphere_Define pxrInternal_v0_20__pxrReserved____UsdGeomSphere_Define
...
#define pxr_UsdGeomSphere_copy pxrInternal_v0_20__pxrReserved____UsdGeomSphere_copy
