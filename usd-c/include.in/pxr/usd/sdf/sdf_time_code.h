...
typedef struct pxrInternal_v0_20__pxrReserved____SdfTimeCode_t_s {
    char data[%SIZEpxrInternal_v0_20__pxrReserved__::SdfTimeCode%];
} USD_CPPMM_ALIGN(%ALIGNpxrInternal_v0_20__pxrReserved__::SdfTimeCode%) pxrInternal_v0_20__pxrReserved____SdfTimeCode_t;
...
#define pxr_SdfTimeCode_sizeof pxrInternal_v0_20__pxrReserved____SdfTimeCode_sizeof


/** returns the size of this type in bytes */
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode_alignof();
#define pxr_SdfTimeCode_alignof pxrInternal_v0_20__pxrReserved____SdfTimeCode_alignof
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode_ctor(
    ...
    , double time);
#define pxr_SdfTimeCode_ctor pxrInternal_v0_20__pxrReserved____SdfTimeCode_ctor
...
#define pxr_SdfTimeCode__eq pxrInternal_v0_20__pxrReserved____SdfTimeCode__eq
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode__ne(
    ...
    , _Bool * return_
    , pxr_SdfTimeCode_t const * rhs);
#define pxr_SdfTimeCode__ne pxrInternal_v0_20__pxrReserved____SdfTimeCode__ne
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode_op_lt(
    ...
    , _Bool * return_
    , pxr_SdfTimeCode_t const * rhs);
#define pxr_SdfTimeCode_op_lt pxrInternal_v0_20__pxrReserved____SdfTimeCode_op_lt
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode_op_gt(
    ...
    , _Bool * return_
    , pxr_SdfTimeCode_t const * rhs);
#define pxr_SdfTimeCode_op_gt pxrInternal_v0_20__pxrReserved____SdfTimeCode_op_gt
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode_op_le(
    ...
    , _Bool * return_
    , pxr_SdfTimeCode_t const * rhs);
#define pxr_SdfTimeCode_op_le pxrInternal_v0_20__pxrReserved____SdfTimeCode_op_le
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode_op_ge(
    ...
    , _Bool * return_
    , pxr_SdfTimeCode_t const * rhs);
#define pxr_SdfTimeCode_op_ge pxrInternal_v0_20__pxrReserved____SdfTimeCode_op_ge
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode__op_mul(
    ...
    , pxr_SdfTimeCode_t const * rhs);
#define pxr_SdfTimeCode__op_mul pxrInternal_v0_20__pxrReserved____SdfTimeCode__op_mul
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode__op_div(
    ...
    , pxr_SdfTimeCode_t * return_
    , pxr_SdfTimeCode_t const * rhs);
#define pxr_SdfTimeCode__op_div pxrInternal_v0_20__pxrReserved____SdfTimeCode__op_div
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode__op_add(
    ...
    , pxr_SdfTimeCode_t * return_
    , pxr_SdfTimeCode_t const * rhs);
#define pxr_SdfTimeCode__op_add pxrInternal_v0_20__pxrReserved____SdfTimeCode__op_add
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode__op_sub(
    ...
    , pxr_SdfTimeCode_t * return_
    , pxr_SdfTimeCode_t const * rhs);
#define pxr_SdfTimeCode__op_sub pxrInternal_v0_20__pxrReserved____SdfTimeCode__op_sub
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode_GetHash(
    pxr_SdfTimeCode_t const * this_
    , size_t * return_);
#define pxr_SdfTimeCode_GetHash pxrInternal_v0_20__pxrReserved____SdfTimeCode_GetHash
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode_GetValue(
    pxr_SdfTimeCode_t const * this_
    , double * return_);
#define pxr_SdfTimeCode_GetValue pxrInternal_v0_20__pxrReserved____SdfTimeCode_GetValue


USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode_copy(
    pxr_SdfTimeCode_t * this_
    , pxr_SdfTimeCode_t const * rhs);
#define pxr_SdfTimeCode_copy pxrInternal_v0_20__pxrReserved____SdfTimeCode_copy


USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____SdfTimeCode_dtor(
    pxr_SdfTimeCode_t * this_);
#define pxr_SdfTimeCode_dtor pxrInternal_v0_20__pxrReserved____SdfTimeCode_dtor
