...
typedef struct pxrInternal_v0_20__pxrReserved____TfType_t_s {
    char _unused;
} USD_CPPMM_ALIGN(8) pxrInternal_v0_20__pxrReserved____TfType_t;
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____TfType_ctor(
    pxr_TfType_t * * this_);
#define pxr_TfType_ctor pxrInternal_v0_20__pxrReserved____TfType_ctor
...
#define pxr_TfType_GetUnknownType pxrInternal_v0_20__pxrReserved____TfType_GetUnknownType
...
an associative map. */
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____TfType__eq(
    pxr_TfType_t const * this_
    , _Bool * return_
    , pxr_TfType_t const * t);
#define pxr_TfType__eq pxrInternal_v0_20__pxrReserved____TfType__eq
...
#define pxr_TfType_IsA pxrInternal_v0_20__pxrReserved____TfType_IsA
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____TfType_IsUnknown(
    pxr_TfType_t const * this_
    , _Bool * return_);
#define pxr_TfType_IsUnknown pxrInternal_v0_20__pxrReserved____TfType_IsUnknown
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____TfType_IsRoot(
    pxr_TfType_t const * this_
    , _Bool * return_);
#define pxr_TfType_IsRoot pxrInternal_v0_20__pxrReserved____TfType_IsRoot
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____TfType_IsEnumType(
    pxr_TfType_t const * this_
    , _Bool * return_);
#define pxr_TfType_IsEnumType pxrInternal_v0_20__pxrReserved____TfType_IsEnumType
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____TfType_IsPlainOldDataType(
    pxr_TfType_t const * this_
    , _Bool * return_);
#define pxr_TfType_IsPlainOldDataType pxrInternal_v0_20__pxrReserved____TfType_IsPlainOldDataType
...
USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____TfType_GetSizeof(
    pxr_TfType_t const * this_
    , size_t * return_);
#define pxr_TfType_GetSizeof pxrInternal_v0_20__pxrReserved____TfType_GetSizeof


USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____TfType_copy(
    pxr_TfType_t * * this_
    , pxr_TfType_t const * rhs);
#define pxr_TfType_copy pxrInternal_v0_20__pxrReserved____TfType_copy


USD_CPPMM_API unsigned int pxrInternal_v0_20__pxrReserved____TfType_dtor(
    pxr_TfType_t * this_);
#define pxr_TfType_dtor pxrInternal_v0_20__pxrReserved____TfType_dtor
